    ...
    private func loadLeistungen() {
        ...
        leistungen = [
            ...
            Leistung(
                ...
                frequency: .monthly,
                category: .geld,
                perPflegegrad: ["1": 0, "2": 34700, "3": 59900, "4": 80000, "5": 99000],
                deadlineRule: nil,
                requiresAntrag: true,
                tip: nil,
                activeFrom: nil,
            ...
            Leistung(
                ...
                frequency: .monthly,
                category: .sach,
                perPflegegrad: ["1": 0, "2": 79600, "3": 149700, "4": 185900, "5": 229900],
                deadlineRule: nil,
                requiresAntrag: true,
            ...
            Leistung(
                slug: "tagesnachtpflege",
                name: "Tages-/Nachtpflege",
                paragraph: "§ 41 SGB XI",
                icon: "🌅",
                shortDescription: "Monatliches Budget für teilstationäre Pflege",
                description: "Pflege in einer Tages- oder Nachtpflegeeinrichtung – tagsüber oder nachts. Kombinierbar mit häuslicher Pflege und Sachleistungen.",
                frequency: .monthly,
                category: .sach,
                perPflegegrad: ["1": 0, "2": 72100, "3": 135700, "4": 168500, "5": 208500],
                deadlineRule: nil,
                requiresAntrag: true,
                tip: "Kann gleichzeitig mit Sachleistungen und Pflegegeld genutzt werden – nicht anrechenbar!",
                activeFrom: nil,
                activeTo: nil
            )
        ]
