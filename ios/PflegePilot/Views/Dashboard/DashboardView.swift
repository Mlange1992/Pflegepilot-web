...
struct LeistungDetailView: View {
    ...
    private let gesetzestexte: [String: String] = [
        ...
        "§ 45b SGB XI": "Pflegebedürftige in häuslicher Pflege haben Anspruch auf einen Entlastungsbetrag in Höhe von bis zu 125 Euro monatlich. Der Betrag ist zweckgebunden einzusetzen für Leistungen zur Entlastung pflegender Angehöriger sowie Förderung der Selbständigkeit und Selbstbestimmtheit der Pflegebedürftigen.",
        "§ 42 SGB XI": "Pflegebedürftige haben Anspruch auf Kurzzeitpflege in einer stationären Einrichtung, wenn die häusliche Pflege zeitweise nicht möglich ist oder nicht ausreicht. Der Anspruch besteht für bis zu acht Wochen je Kalenderjahr, die Kosten werden bis zu 1.774 Euro je Kalenderjahr übernommen.",
        "§ 39 SGB XI": "Kann die häusliche Pflege nicht in ausreichendem Umfang sichergestellt werden, besteht Anspruch auf Verhinderungspflege. Die Pflegekasse übernimmt die Kosten bis zu 1.612 Euro im Kalenderjahr für bis zu sechs Wochen.",
        "§ 40 SGB XI": "Pflegebedürftige haben Anspruch auf Versorgung mit Pflegehilfsmitteln, die zur Erleichterung der Pflege oder zur Linderung der Beschwerden des Pflegebedürftigen beitragen. Zum Verbrauch bestimmte Pflegehilfsmittel werden bis zu 40 Euro monatlich erstattet.",
        "§ 40 Abs. 4 SGB XI": "Maßnahmen zur Verbesserung des individuellen Wohnumfeldes des Pflegebedürftigen können gefördert werden, wenn dadurch die häusliche Pflege ermöglicht oder erheblich erleichtert oder eine möglichst selbständige Lebensführung wiederhergestellt wird. Den Zuschuss je Maßnahme kann bis zu 4.180 Euro betragen (Stand 2025/2026).",
                ...
                Section {
                    VStack(alignment: .leading, spacing: 6) {
                        Text("Hinweis")
                            .font(.caption.bold())
                            .foregroundColor(.secondary)
                        Text("Diese App ersetzt keine professionelle Pflegeberatung. Alle Beträge: Stand 2025/2026. Empfehlungen können Affiliate-Links enthalten (als 'Anzeige' gekennzeichnet).")
                            .font(.caption)
                            .foregroundColor(.secondary)
